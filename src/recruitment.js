...
class Recruitment extends Component {
  ...
  <header id="masthead" className="site-header" data-anchor-target=".hero-recruitment" data-top="background: rgba(255,255,255,0); padding: 30px 0; box-shadow: 0px 0px 20px 6px rgba(0, 0, 0, 0); color:white;" data-top-bottom="background: rgba(255,255,255,1); padding: 10px 0; box-shadow: 0px 0px 20px 6px rgba(0, 0, 0, 0.2);">
  ...
  {/* /#header */}
  <div id="hero-recruitment" className="hero-recruitment" style={{zIndex: 999}}>
    <div className="container">
      <div className="row">
  ...
  {/*</section>-*/}
  {/* /.section-form */}
  <footer id="colophon" className="site-footer" style={{zIndex: 1}}>
    <div className="container">
      <div className="row">
        <p className="copyright">© 2021. GDT All Rights Reserved.</p>
      </div>
    </div>
  </footer>
  {/* /#footer */}
